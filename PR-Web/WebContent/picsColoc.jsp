		...
		<font style="font-size:40pt; color:white;"><b>Mes Colocs</b></font>
			...
			<div align="center" style="margin:auto; position:absolute; top:50%; transform:translateY(-50%); right:5%;">
				<form action="ColocServlet" method="post">
					<button type="submit" style="padding-left:16px; padding-right:16px; padding-bottom:10px; padding-top:10px; margin: auto; width: 100%; font-size:1.1em; color:white" class="btn btn-large btn btn-success btn-lg btn-block" value="logOut" name="ok" >Log Out</button>
				</form>
			</div>
