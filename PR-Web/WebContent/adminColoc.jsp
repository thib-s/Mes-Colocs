...
<html lang="en">
<head>
<title>Administration of your Coloc</title>
<meta charset="utf-8">
		...
		<div class="row content">
			<div class="col-sm-2 sidenav">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a
						href="http://localhost:8080/PR-Web/adminColoc.jsp">Administrate
							Coloc</a></li>
			...
			<div class="col-sm-9" style="padding: 15px; margin-left: 20px">
				<h4>
					<small>Administrate your coloc</small>
				</h4>
				<form action="ColocServlet" method="post">

					<div class="form-group">
						<label for="exampleInputEmail1">New name for the coloc</label> <br>
						<input type="text"
							style="width: 100%; margin: auto; box-sizing: border-box;"
							class="form-control" name="txtNewColocName" id="txtNewColocName"
					...
					<button type="submit" style="width: 100%; font-size: 1.1em;"
						class="btn btn-large btn btn-success btn-lg btn-block" value="changeName"
						name="ok">
						<b>Change name</b>
					</button>
				</form>
				...
				<form action="ColocServlet" method="post">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">New Address</label> <br>
						<input type="text"
							style="width: 100%; margin: auto; box-sizing: border-box;"
							class="form-control" name="txtNewColocAddress" id="txtNewColocAddress"
							placeholder="Enter New Address">

					</div>
					<br>
					<div class="form-group">
						<label for="exampleInputEmail1">New City</label> <br>
						<input type="text"
							style="width: 100%; margin: auto; box-sizing: border-box;"
							class="form-control" name="txtNewColocCity" id="txtNewColocCity"
							placeholder="Enter New City">

					</div>
					<br>
					<div class="form-group">
						<label for="exampleInputEmail1">New Country</label> <br>
						<input type="text"
							style="width: 100%; margin: auto; box-sizing: border-box;"
							class="form-control" name="txtNewColocCountry" id="txtNewColocCountry"
					...
					<br> <br>
					<button type="submit" style="width: 100%; font-size: 1.1em;"
						class="btn btn-large btn btn-success btn-lg btn-block" value="changeAddress"
						name="ok">
						<b>Change Address</b>
					</button>
				</form>
