...
<html lang="en">
<head>
  <title>Expenses of your Coloc</title>
  <meta charset="utf-8">
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="http://localhost:8080/PR-Web/expensesColoc.jsp">Expenses</a></li>
    ...
    <div class="col-sm-9" style="padding:15px; margin-left:20px">
      <h4><small>Expenses of your coloc</small></h4>
